...
# -*- coding: utf-8 -*-
#
# Kur documentation build configuration file, created by
...
version = project_release.rsplit('.', 1)[0]
...
exclude_patterns = ['mnist-example.rst']
...
latex_documents = [
    (master_doc, 'Kur.tex', 'Kur Documentation',
     'Deepgram', 'manual'),
]
...
man_pages = [
    (master_doc, 'kur', 'Kur Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Kur', 'Kur Documentation',
     author, 'Kur', 'One line description of project.',
     'Miscellaneous'),
]
